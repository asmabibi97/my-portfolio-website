    ...
    <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
      ...
      <div className="lg:w-1/3 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a className="text-gray-400 hover:text-white">our achievments</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/3 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-400 hover:text-white">goals</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-white">our vission</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-white">testimonals</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-white">catlogs </a>
          </li>
        </nav>
      </div>
    </div>
